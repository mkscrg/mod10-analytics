...
-- | The first command-line argument is taken as the path to the stats files.
-- The file is read into a string and broken into "chunks" representing
-- separate outputs from Mod10. Each chunk is mapped to an IO action to make a
-- .png plot of the associated frequency data.
main :: IO ()
main = do
    argv <- getArgs
    stats <- readFile $ head argv
...
-- | Break the lines of the stats file into groups at blank lines
